...
export const ROLES: RoleConfig[] = [
...

  {
    ...
    label:                "Editorial MUA",
    category:             "creative_visual",
    defaultTargetMarkets: ["beauty_brands", "fashion_agencies", "pr_talent_agencies", "editorial_magazines"],
...

  {
    ...
    category:             "creative_visual",
    defaultTargetMarkets: ["beauty_brands", "pr_talent_agencies", "fashion_agencies", "retail_brands"],
