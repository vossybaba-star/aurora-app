...
export interface CompanyAnalysis {
  name?: string;
  /** 3-5 sentences covering what the company does, who it serves, and key differentiators */
  description: string;
  value_proposition: string;
  /** product name → brief summary (auto-generated by Kammie) */
  key_products?: Record<string, string>;
  key_features: string[];
  /** 0-1 confidence score based on scrape quality: full site = 1.0, homepage only = 0.6, fallback = 0.3 */
...
export interface ICP {
  ...
  /** Mid-level titles: daily users and internal advocates */
  champions: string[];
  /** C-suite and heads-of: budget holders and final sign-off */
  decision_makers: string[];
  /** Keyed by persona title — shared across champion and decision maker tiers */
  pain_points: Record<string, string[]>;
  /** Keyed by persona title — what this persona is measured on */
  goals: Record<string, string[]>;
  /** Keyed by persona title — common objections to buying */
